...
export function createEvalFixtures(mode: EvalFixtureMode): Record<string, EvalFixtureRunner> {
  return {
    ...
    'handoff-done': runHandoffDoneFixture,
  };
}
